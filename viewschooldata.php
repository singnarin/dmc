...
<body><div align="center">
	...
	{	
			$strSQLstatus = "SELECT * FROM  tbstatus where schoolid = '".$txtschoolid."'";
...
<table width="900" border="0">
  ...
  <tr>
    <td><table width="900" border="0">
      ...
      <tr>
		...
		<?php
		$strSQL = "SELECT * FROM  `tbschool` WHERE schoolid = '".$txtschoolid."'";
      ...
      <tr>
        <td>อนุบาล 1</td>
		<?php
		$strSQL1 = "SELECT * FROM  `tbo1` WHERE schoolid ='".$txtschoolid."'";
      ...
      <tr>
        <td>อนุบาล 2</td>
		<?php
		$strSQL2 = "SELECT * FROM  `tbo2` WHERE schoolid ='".$txtschoolid."'";
      ...
      <tr>
		...
		<?php
		$strSQLp1 = "SELECT * FROM  `tbp1` WHERE schoolid ='".$txtschoolid."'";
      ...
      <tr>
		...
		<?php
		$strSQLp2 = "SELECT * FROM  `tbp2` WHERE schoolid ='".$txtschoolid."'";
      ...
      <tr>
		...
		<?php
		$strSQLp3 = "SELECT * FROM  `tbp3` WHERE schoolid ='".$txtschoolid."'";
      ...
      <tr>
		...
		<?php
		$strSQLp4 = "SELECT * FROM  `tbp4` WHERE schoolid ='".$txtschoolid."'";
      ...
      <tr>
		...
		<?php
		$strSQLp5 = "SELECT * FROM  `tbp5` WHERE schoolid ='".$txtschoolid."'";
      ...
      <tr>
		...
		<?php
		$strSQLp6 = "SELECT * FROM  `tbp6` WHERE schoolid ='".$txtschoolid."'";
      ...
      <tr>
		...
		<?php
		$strSQLm1 = "SELECT * FROM  `tbm1` WHERE schoolid ='".$txtschoolid."'";
      ...
      <tr>
		...
		<?php
		$strSQLm2 = "SELECT * FROM  `tbm2` WHERE schoolid ='".$txtschoolid."'";
      ...
      <tr>
		...
		<?php
		$strSQLm3 = "SELECT * FROM  `tbm3` WHERE schoolid ='".$txtschoolid."'";
      ...
      <tr>
		...
		<?php
		$strSQLteacher = "SELECT * FROM  `tbt` WHERE schoolid ='".$txtschoolid."'";
      ...
      <tr>
        <td>พนักงานราชการ</td>
		<?php
		$strSQLemployee = "SELECT * FROM  `tbe` WHERE schoolid ='".$txtschoolid."'";
      ...
      <tr>
		...
		<?php
		$strSQLforeigner = "SELECT * FROM  `tbf` WHERE schoolid ='".$txtschoolid."'";
      ...
      <tr>
		...
		<?php
		$strSQLtemporary = "SELECT * FROM  `tbc` WHERE schoolid ='".$txtschoolid."'";
  ...
  <tr>
    <td><div align="center">
		<input type="button" name="Button" value="แก้ไขข้อมูล" onClick="window.location.href='updateschooldata.php?txtschoolid=<?php echo $txtschoolid ?>'">
		<a href="export_viewschooldata.php?txtschoolid=<?php echo $txtschoolid ;?>" target = "_blank">
		<input type="button" name="Button" value="พิมพ์เอกสาร" onClick="#"></a>
...
<?php
	...
	$message = "โรงเรียนยังไม่ได้บันทึกข้อมูล";
