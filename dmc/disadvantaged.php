   ...
   var params =  "txtschool=" + document.getElementById("txtschool").value + "&txtstudentID=" + document.getElementById("txtstudentID").value + "&txtempID=" + document.getElementById("txtempID").value + "&txtclass=" + document.getElementById("txtclass").value + "&txtroom=" + document.getElementById("txtroom").value + "&txtNstudent=" + document.getElementById("txtNstudent").value + "&txtLstudent=" + document.getElementById("txtLstudent").value + "&txtdisadvantaged=" + document.getElementById("txtdisadvantaged").value + "&poorBookFlag=" + document.getElementById("poorBookFlag").checked + "&poorFoodFlag=" + document.getElementById("poorFoodFlag").checked + "&poorStationeryFlag=" + document.getElementById("poorStationeryFlag").checked + "&poorUniformFlag=" + document.getElementById("poorUniformFlag").checked; 
    ...
    if (obj.readyState == 3 ){ 
      ...
      if (obj.readyState == 4 ) { 
        ...
        document.getElementById("txtdisadvantaged").value = '' ;
        document.getElementById("poorBookFlag").checked = '' ;
        document.getElementById("poorFoodFlag").checked = '' ;
        document.getElementById("poorStationeryFlag").checked = '' ;
        document.getElementById("poorUniformFlag").checked = '' ;
     } 
    } 
  }   
  } 
  function ExportData() { 
   window.location =  "disadvantagedExport.php?txtschool=" + document.getElementById("txtschool").value + "&txtstudentID=" + document.getElementById("txtstudentID").value + "&txtempID=" + document.getElementById("txtempID").value + "&txtclass=" + document.getElementById("txtclass").value + "&txtroom=" + document.getElementById("txtroom").value + "&txtNstudent=" + document.getElementById("txtNstudent").value + "&txtLstudent=" + document.getElementById("txtLstudent").value + "&txtdisadvantaged=" + document.getElementById("txtdisadvantaged").value + "&poorBookFlag=" + document.getElementById("poorBookFlag").checked + "&poorFoodFlag=" + document.getElementById("poorFoodFlag").checked + "&poorStationeryFlag=" + document.getElementById("poorStationeryFlag").checked + "&poorUniformFlag=" + document.getElementById("poorUniformFlag").checked ;  
  }
</script>
<style type="text/css">
<?php 
...
<table width="900"  border="0">
  ...
  <tr>
  	<td><div align="center"><h4>ข้อมูลนักเรียนรายบุคคลจำแนกตามความด้อยโอกาส,ขาดแคลน</h4></div></td>
  </tr>
<table border="0">
	...
	<tr>
		<td ><div align="right"><br>ความด้อยโอกาส</div></td>
		<td ><br>
		<select name="txtdisadvantaged" id = "txtdisadvantaged">
			<option value=""></option>
			<option value="เด็กถูกบังคับให้ขายแรงงาน">เด็กถูกบังคับให้ขายแรงงาน</option>
        	<option value="เด็กที่อยู่ในธุรกิจทางเพศ">เด็กที่อยู่ในธุรกิจทางเพศ</option>
