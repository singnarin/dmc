...
<table width="900" border="0">
  ...
  <tr>
    <td><div align="center">จำนวนบุคลากรในโรงเรียน</div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
		...
		<table width="973" border="1" bordercolor="#0000FF" style="border-collapse:collapse;" >
  		<tr>
...
<div align="center">
		...
		<input type="button" name="Button" value="พิมพ์เอกสาร" onClick="window.location.href='export_sumperson.php'"></div>
</div>
<?php
}else{
