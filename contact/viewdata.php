...
<table width="900" border="0"><form id="form1" name="form1" method="post" action="editdata.php">
  <tr>
  ...
  <tr>
    <td><br><br>
		...
		<table width="900" border="1" bordercolor="#0000FF" style="border-collapse:collapse;" >
			...
			?>
				<td><?php echo $objResult["director"]; ?></td>
				<td><?php echo $objResult["teldirector"]; ?></td>
				<td><?php echo $objResult["contact"]; ?></td>
				<td><?php echo $objResult["telcontact"]; ?></td>
			</tr>
		</table>
    </td>
  </tr>
  <tr>
    <td><div align="center"><input type="submit" name="Submit" value="แก้ไขข้อมูล" />
