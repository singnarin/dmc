...
<table width="900" border="0"><form id="form1" name="form1" method="post" action="editdata1.php">
  <tr>
  ...
  <tr>
    <td><br><br>
		...
		<table width="900" border="1" bordercolor="#0000FF" style="border-collapse:collapse;" >
			...
			<tr>
			<?php
				$objQuery = mysql_query("SELECT * FROM  `contact` WHERE schoolid ='".$_SESSION['ses_username']."'") or die ("Error Query");
			...
			?>
				...
				<td><input type="text" name="telcontact" maxlength="10" value="<?php echo $objResult["telcontact"]; ?>"/></td>
			</tr>
		</table>
    </td>
  </tr>
