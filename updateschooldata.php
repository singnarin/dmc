...
<table width="900" border="0"><form id="form1" name="form1" method="post" action="updateschooldata1.php">
  <tr>
  ...
  <tr>
    <td><table width="900" border="0">
      ...
      <tr>
        ...
        <td><input type="hidden" name="txtschoolid" value="<?php echo $txtschoolid ;?>" /></td>
      </tr>
    </table></td>
  </tr>
  <tr>
